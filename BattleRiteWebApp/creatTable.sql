...
CREATE TABLE BattleRite(
	BattleRiteName 	VARCHAR (50),
	ChampionName 	VARCHAR (50),
	Description 	VARCHAR (500),
	BattleRiteType 	VARCHAR (25),
	Image			VARCHAR (200),
	PRIMARY KEY (BattleRiteName, ChampionName)
);
...
INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES ('Alysia' , 'From the frozen north comes the ice sculptor Alysia. Her power allows her to wield ice with both grace and deadly precision. She can damage and freeze her enemies from a distance, while shielding her allies with ice. Obsessed with shapes and form, she left her icy fortress of solitude to seek inspiration in the arena.', 'https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/6/6d/Alysia_Portrait.png?version=b6bb7d024dbd986a3971b789c9a4f70d', 'Ranged');

INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Ashka','A masked creature specialized in dark sorcery and pyro-kinetic powers. Casting devastating fire spells on his opponents, staying away from close combat. Don’t be fooled by his size, Ashka’s inner demon strikes fear into all who face him.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/3/33/Ashka_Portrait.png?version=62a459f3d2fd2ae884aa75c65db2308b', 'Ranged');
...
INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Iva','A scavenger from the outer realms. Iva has engineered her own arsenal of weapons. Firing crazy rockets or unleashing a storm of bullets is her way of greeting her opponents in the Arena.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/d/dc/Iva_Portrait.png?version=acd00a76b53208366cf7dfd714e37bb3', 'Ranged');
...
INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Jumong','Jumong is a trophy collector who has wandered the wildlands in the pursuit of a worthy challenge. No longer content with hunting the great beasts of the world, has led him to enter the arena looking for a new type of prey. He traps his foes and ends them with a well placed shot from his mighty bow.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/7/74/Jumong_Portrait.png?version=2757dbb8e54b8a60abe8b9be70bf19d6', 'Ranged');

INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Taya','An exceptionally swift hunter wielding a razor sharp boomerang. By shaping the wind around her taya is able to increase her speed and control her boomerang with deadly precision.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/2/26/Taya_Portrait.png?version=ae2a6a6b3f0e4666428c12ad5dcbbbe8', 'Ranged');

INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Varesh','A being formed by the energies of others. Varesh uses his power to weaken and disrupt his enemies. By combining his powers he is able to unleash devastating attacks.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/2/20/Varesh_Portrait.png?version=f64ad2b5a1ce4864095cfb6e110dba13', 'Ranged');

INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Bakko','Bakko has a proud history, filled with bravery and courage. Most known for saving hundreds of people from getting slaughtered by the giants in the north. A heroic brawler armed with axe and shield. Bakko uses his shield to outmaneuver opponents and protect his teammates. Watch out for his earth shattering dash attacks, even calm warriors sometimes go berserk.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/1/1d/Bakko_Portrait.png?version=43b8d9770e5a80d5682afe71da2dccc9', 'Melee');
...
INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Oldur','Oldur is a mysterious creature able to bend time and space. He can mend wounds with powerful heals and reverse enemy attacks by freezing them in time.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/0/0e/Oldur_Portrait.png?version=18d9fa00dd359be1001a9ad91d347348', 'Support');

INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Pearl','Pearl is a sage able to control the oceans and whatever creatures that lurk below. Pearl transforms water into volatile attacks, rejuvenating streams and protecting bubbles.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/0/05/Pearl_Portrait.png?version=3a6fa7a029c11ca7282c699a9383bec4', 'Support');

INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Pestilus','Pestilus is the head priest of Quna. He serves the Qunan royal family, but secretly worships an evil deity, Rasal. His schemes manipulated the king into exiling the crown prince. In the arena, Pestilus unleashes swarms of insects to infest and cripple his enemies, releasing his innermost darkest desires.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/f/f2/Pestilus_Portrait.png?version=2966517b8571c821014587a947b0c860', 'Support');

INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Poloma','A psychopomp from the deep forests of Silverridge, Poloma uses shamanic powers to guide life and spirits alongside her protector and loyal creature, Toki. A dark disturbance among souls has put Poloma on a new path, leaving her safety and home behind. Driven by her burning curiosity and extraordinary senses, Poloma now seeks her answers in the arena.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/6/64/Poloma_Portrait.png?version=88e987984f260248862e6362e0c1ed63', 'Support');

INSERT INTO Champion (ChampionName, ChampionBio, Image, ChampionType)
VALUES('Sirius','Born under a purple sky and wrapped in the light of the brightest star, the prophecy was true and foretold the birth of the Zenith. Taken from his parents and sent to a monastery to learn the the way of the astronomers, Sirius is a calm prodigy who uses the energies of stars and planets as destructive spells and healing powers.','https://d1u5p3l4wpay3k.cloudfront.net/battlerite_gamepedia_en/4/42/Sirius_Portrait.png?version=264f29322ce6d86cb473341114ffb466', 'Support');
